...
<%@page import="model.NoticeDataBean"%>
	...
	<c:if test="${count!=0}">
		...
		<div align="center">
			<table class="table4_11" style="width: 75%;">
				<tr style="border: 0">
					<td colspan=6 style="border: 0"><c:if test="${memEmpno == 0}">
				...
				<c:forEach var="article" items="${li}">
					<tr>
						...
						<td align="center" width="50%"><a
							href="${pageContext.request.contextPath}/notice/content?num=${article.num}" style="color: grey">${article.subject}</a></td>
