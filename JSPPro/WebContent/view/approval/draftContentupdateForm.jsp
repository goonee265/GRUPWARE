...
<div align="center">
	...
	action="${pageContext.request.contextPath}/approval/draftContentUpdatePro">
	...
	<div>		
		<table class="table4_3" style="width: 50%;">
			...
			<tr>
				...
				<td>
					<input type="text" size="45" style="border-radius: 5px;" name="subject" value="${article.subject }">
			...
			<tr style="border:0">
				<td colspan=2 align="center" style="border:0">
					<input type="submit" value="수정하기" class="myButton" style="color: white">
