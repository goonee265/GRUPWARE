...
<c:set var="pw" value="${c.getPassword()}" />
<c:set var="pwq" value="${c.getPwqno()}" />
<c:set var="pwa" value="${c.getPwqans()}" />
...
<c:if test="${pwq eq pwqno}" > 
	
	<c:if test="${pwa eq pwqanstext}"> 
	<div align="center">
<br><br>
...
<!-- 		 <br><br>
	...
	<c:if test="${pwa ne pwqanstext}">
	<div align="center">
<br><br>

		 비밀번호 찾기 질문 혹은 답이 잘못되었습니다.
...
<%-- <table width="270" border="0" cellspacing="0" cellpadding="5">
	<tr>
		<td align="center">
			...
			<p> 입력하신 사번 <%=empno%>은(는) 존재하지 않습니다. </p>
			
	<form name="checkForm" method="post" action="confirmEmpno.jsp" autocomplete="off">
